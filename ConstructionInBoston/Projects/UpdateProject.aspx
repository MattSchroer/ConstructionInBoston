<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateProject.aspx.cs" Inherits="ConstructionInBoston.Projects.UpdateProject" %>
            ...
            <div class="col-xs-12 col-sm-9">
                ...
                <div class="row">
                    <form runat="server">
                        ...
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="StatusCombo">Status</asp:Label>
                            <asp:DropDownList runat="server" class="form-control" ID="StatusCombo" />
                        </div>
                        <div class="form-group">
